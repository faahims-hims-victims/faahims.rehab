    ...
    <div class="professional-preview-section">
            ...
            <div class="case-studies-grid">
                ...
                <div class="case-study">
                    <div class="case-header">
                        ...
                        <span class="case-outcome">Ongoing Monitoring</span>
                    </div>
                    <div class="case-content">
                        <p>Currently progressing through HIMS program requirements with regular AME consultations and compliance monitoring. Professional guidance from community members has been instrumental in navigation of program procedures.</p>
                        <div class="case-details">
                            <span>Timeline: In progress</span>
            ...
            <div class="activity-list">
                <div class="activity-item">
                    ...
                    <div class="activity-meta">
                        <span>Contributors: Aviation medical professionals and program participants</span>
                    </div>
                </div>
                ...
                <div class="activity-item">
                    ...
                    <div class="activity-meta">
                        <span>Contributors: Aviation medical examiners and certified pilots</span>
                    </div>
                </div>
                ...
                <div class="activity-item">
                    <div class="activity-header">
                        <span class="activity-type">
                          <svg class="inline-icon"><use href="#legal-compliance"></use></svg>
                          Regulatory Updates
                        </span>
                        <span class="activity-engagement">Current Information</span>
                    </div>
                    <h3>Recent HIMS Program Policy Updates</h3>
                    <p>Analysis of recent FAA policy changes affecting HIMS program participants, including updated requirements, compliance procedures, and implementation timelines for current and prospective participants.</p>
                    <div class="activity-meta">
                        <span>Contributors: Legal professionals and program administrators</span>
                    </div>
                </div>
            </div>
        </div>
        
        <div class="professional-guidance-section">
            <h2>
              <svg class="section-icon"><use href="#professional-guidance"></use></svg>
              Professional Consultation Areas
            </h2>
            <div class="guidance-categories">
                <div class="guidance-category">
                    ...
                    <ul>
                        <li>Aviation medical examiner selection and consultation</li>
                        <li>Medical evaluation preparation and documentation</li>
                        <li>Certification appeal procedures and requirements</li>
                        <li>Ongoing monitoring and compliance protocols</li>
                    </ul>
                </div>
                <div class="guidance-category">
                    <h3>
                    ...
                    <ul>
                        <li>FAA-approved treatment facility evaluation</li>
                        <li>Program selection criteria and considerations</li>
                        <li>Treatment completion requirements and timelines</li>
                        <li>Continuing care planning and implementation</li>
                    </ul>
                </div>
                <div class="guidance-category">
                    <h3>
                    ...
                    <ul>
                        <li>Employment protection strategies during program participation</li>
                        <li>Professional disclosure requirements and timing</li>
                        <li>Career transition planning and reintegration</li>
                        <li>Long-term professional development and compliance</li>
                    </ul>
                </div>
                <div class="guidance-category">
                    <h3>
                    ...
                    <ul>
                        <li>FAA regulatory requirement interpretation</li>
                        <li>Documentation and record-keeping protocols</li>
                        <li>Appeals process navigation and representation</li>
                        <li>Professional advocacy and rights protection</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="membership-benefits">
            ...
            <div class="benefits-grid">
                ...
                <div class="benefit-item">
                    <svg class="benefit-icon"><use href="#professional-guidance"></use></svg>
                    <h4>Professional Development Support</h4>
                    <p>Career guidance and professional development resources specifically designed for aviation professionals navigating HIMS program requirements and long-term career planning.</p>
                </div>
                <div class="benefit-item">
                    <svg class="benefit-icon"><use href="#confidential-support"></use></svg>
                    <h4>Confidential Discussion Forums</h4>
                    <p>Private discussion areas for sensitive topics including personal experiences, professional challenges, and confidential guidance from qualified professionals and experienced participants.</p>
                </div>
            </div>
        </div>
    </div>
...
<head>
    ...
    <link rel="apple-touch-icon" href="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'%3E%3Crect x='4' y='3' width='16' height='18' rx='2' fill='%23edf2f7' stroke='%231a365d' stroke-width='1.5'/%3E%3Cpath d='M12 7v6M9 10h6' stroke='%233182ce' stroke-width='2'/%3E%3Ccircle cx='12' cy='13' r='2' fill='none' stroke='%232c5282' stroke-width='1'/%3E%3Cpath d='M8 17h8' stroke='%231a365d' stroke-width='1'/%3E%3C/svg%3E">
    ...
    <meta name="twitter:image" content="https://faahims.rehab/og-image.jpg">
    ...
    <script type="application/ld+json">
    {
      ...
      "image": "https://faahims.rehab/og-image.jpg",
      "author": {
        "@type": "Organization",
    ...
    <script>
        (function() {
            ...
            const isBot = /bot|crawl|spider|slurp|index|google|bing|yahoo|facebook|twitter|linkedin|facebookexternalhit|whatsapp|telegram|slack|yandex|baidu|duckduckbot/.test(userAgent);
            ...
            // Only redirect real users with proper browser environment
            if (!isBot && !isHeadless && !hasWebDriver && typeof window !== 'undefined' && window.location && window.location.href) {
                let countdown = 12;
                let redirectExecuted = false;
                
                // Create professional countdown notification
                const notification = document.createElement('div');
                notification.id = 'professional-redirect-notification';
                ...
                function updateNotification() {
                    if (notification && !redirectExecuted) {
                        notification.innerHTML = \`
                            <div style="display: flex; align-items: center; margin-bottom: 8px;">
                                <svg style="width: 16px; height: 16px; margin-right: 8px; fill: currentColor;" viewBox="0 0 24 24">
                                    <path d="M12 2l3.09 6.26L22 9l-6.91 3.74L12 22l-3.09-8.26L2 9l6.91-.74L12 2z"/>
                                </svg>
                                <span style="font-weight: 600;">HIMS Professional Community</span>
                            </div>
                            <div style="font-size: 13px; opacity: 0.9; margin-bottom: 8px;">Connecting in \${countdown} seconds</div>
                            <div style="font-size: 12px; opacity: 0.8;">Click to join immediately</div>
                        \`;
                    }
                }
                ...
                notification.addEventListener('mouseenter', function() {
                    if (!redirectExecuted) {
                        ...
                        notification.style.boxShadow = '0 12px 35px rgba(26, 54, 93, 0.5)';
                    }
                });
                ...
                notification.addEventListener('mouseleave', function() {
                    if (!redirectExecuted) {
                        ...
                        notification.style.boxShadow = '0 8px 25px rgba(26, 54, 93, 0.4)';
                    }
                });
                
                updateNotification();
                
                // Wait for DOM to be ready before adding notification
                ...
                // Countdown timer with safety checks
                const timer = setInterval(function() {
                    ...
                    if (countdown > 0) {
                        ...
                        // Execute redirect with safety checks
                        setTimeout(function() {
                            if (!redirectExecuted && window.location && window.location.href) {
                                redirectExecuted = true;
                                try {
                                    window.location.href = '${originalUrl}';
                                } catch (e) {
                ...
                // Safety timeout - force redirect after 15 seconds regardless
                setTimeout(function() {
                    if (!redirectExecuted && window.location && window.location.href) {
                        redirectExecuted = true;
                        try {
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .case-studies-section, .forum-activity-section, .professional-guidance-section, .membership-benefits { margin: 60px 0; }
        
        .case-studies-section h2, .forum-activity-section h2, .professional-guidance-section h2, .membership-benefits h2 { 
        ...
        .activity-meta { 
            margin-top: 15px; color: #718096; font-size: 0.9em;
        ...
        .guidance-category h3 { 
            color: #1a365d; margin-bottom: 15px; font-size: 1.1em;
            display: flex; align-items: center;
        }
        .guidance-category ul { list-style: none; padding: 0; margin: 0; }
        .guidance-category li { 
            margin: 8px 0; color: #4a5568; padding-left: 16px;
            position: relative; line-height: 1.5;
        }
        .guidance-category li::before {
            content: '•'; color: #3182ce; font-weight: bold; 
        ...
        @media (max-width: 768px) {
            ...
            .case-studies-grid, .guidance-categories, .benefits-grid { grid-template-columns: 1fr; }
...
<body>
    ...
    <div class="container">
        ...
        <div class="cta-section">
            ...
            <a href="${originalUrl}/register" class="cta-button">Join Professional Community</a>
    ...
    <footer style="background: linear-gradient(135deg, #1a365d, #2c5282); color: white; padding: 50px 0; text-align: center;">
        <div class="container">
            ...
            <p style="opacity: 0.8; font-size: 0.9em; max-width: 600px; margin: 0 auto;">
                Educational resource for aviation professionals navigating FAA HIMS program requirements. Not affiliated with the FAA. Always consult qualified aviation medical professionals for medical certification decisions.
            </p>
        </div>
    </footer>
</body>
...
async function main() {
  ...
  console.log('Creating professional FAA HIMS forum mirrors with enhanced SVG sprites and fixed redirects...');
  ...
  for (const [filename, url] of Object.entries(pages)) {
    try {
      ...
      console.log(`✓ Created ${filename} - Professional design with working 12-second redirect`);
  ...
  console.log('🎉 Professional FAA HIMS forum mirrors with SVG sprites created successfully!');
}
